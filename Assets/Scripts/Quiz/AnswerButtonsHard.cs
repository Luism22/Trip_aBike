...
public class AnswerButtonsHard : MonoBehaviour
{
    //anwers A
    ...
    public void AnswerA()
    {
        if (QuestionGenerateHard.actualAnswer == "A")
        {
    ...
    public void AnswerB()
    {
        if (QuestionGenerateHard.actualAnswer == "B")
        {
    ...
    public void AnswerC()
    {
        if (QuestionGenerateHard.actualAnswer == "C")
        {
    ...
    public void AnswerD()
    {
        if (QuestionGenerateHard.actualAnswer == "D")
        {
    ...
    IEnumerator NextQuestion()
    {
        ...
        QuestionGenerateHard.displayingQuestion = false;
    }
}
