...
public class AnswerButtonsMedium : MonoBehaviour
{
    //anwers A
    ...
    public void AnswerA()
    {
        if (QuestionGenerateMedium.actualAnswer == "A")
        {
    ...
    public void AnswerB()
    {
        if (QuestionGenerateMedium.actualAnswer == "B")
        {
    ...
    public void AnswerC()
    {
        if (QuestionGenerateMedium.actualAnswer == "C")
        {
    ...
    public void AnswerD()
    {
        if (QuestionGenerateMedium.actualAnswer == "D")
        {
    ...
    IEnumerator NextQuestion()
    {
        ...
        QuestionGenerateMedium.displayingQuestion = false;
    }
}
